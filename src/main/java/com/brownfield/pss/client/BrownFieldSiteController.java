 ...
 */
   ...
   public String greetingSubmit(@RequestHeader(value = "xCorrelationId", required = false) String xCorrelationId, 
		   @ModelAttribute UIData uiData, Model model) {
	   System.out.println(xCorrelationId);
   ...
   public UIData greetingSubmit(@RequestHeader(value = "xCorrelationId", required = false) String xCorrelationId, 
		   @RequestBody  UIData uiData) {
	   return new UIData();
	   //System.out.println(xCorrelationId);
		//Flight[] flights = searchClient.postForObject("http://localhost:8090/search/get", uiData.getSearchQuery(), Flight[].class); 
		//uiData.setFlights(Arrays.asList(flights));
